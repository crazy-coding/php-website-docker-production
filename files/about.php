    ...
    <div class="container">
        <div class="row align-items-center pos-rel">
            ...
            <div class="col-lg-5 col-md-12 text-center">
                ...
                <img src="images/about-banner-a.png" class="about-banner-a">
                <img src="images/about-banner-b.png" class="about-banner-b">
                </div>
            </div>
        </div>
    </div>
...
<div class="page-content about-page">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 ml-auto mr-auto text-center">
                ...
                <h2>Our Core Values and Strength</h2>
                <p class="core-value-desc">Our exclusive features will give you the extra push over the other typical providers so that your  business sores and remains hasslefree.</p>
                </div>
            </div>
        </div>
        <div class="row about-core">
            <div class="col-lg-4 col-md-6">
                ...
                <div class="featured-desc">
                    <p>We've been in business for over ten years and have become the leading authority in text messaging. You don't have to worry about working with some fly-by-night company - we're solid, and we have years of experience.</p>
                </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 sm-mt-5">
                ...
                <div class="featured-desc">
                    <p>Whether you're just getting started, or you need advanced support, our team will make sure you get answers. We're always here to help, so much so, we've held a 99% satisfaction rating multiple years running.</p>
                </div>
                </div>
            </div>
    ...
    <section class="help-section blue-section inner-sec mg-100 about-slider">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="section-title">
                    ...
                    <p class="core-value-desc color-white">Trusted by thousands of customers in multiple markets.</p>
                </div>
                </div>
            </div>
            <div class="row">
