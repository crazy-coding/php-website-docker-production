    ...
    <div class="row align-items-center">
        <div class="col-md-12">
            ...
            <nav aria-label="breadcrumb" class="page-breadcrumb">
                <ol class="breadcrumb">
                <li class="breadcrumb-item active" aria-current="page">Thanks For Taking The Time To Learn About Sendplex’s Terms Of Use. It’s Important Stuff. This Is Where You’ll Find Information About How We Protect Your Privacy, What You Can And Can’t Do With Sendplex, And How We Handle User Accounts. Have Questions? Send Us An Email.</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12">
                ...
                <h4 class="text-theme mt-5">5. NONDISCLOSURE</h4>
                <p class="mb-5">Either Party may disclose the general existence and nature of any Agreement between the Parties, but may not disclose the specific terms of any Agreement without the prior consent of the other Party, unless the Agreement is publicly available. Sendplex shall not issue a press release concerning any agreement with Licensee without first obtaining the cooperation and permission of Licensee.</p>
                <h4 class="text-theme mt-5">6. TERM AND TERMINATION</h4>
                <p class="mb-5">At its discretion, Sendplex may end the Service or Services at any time.
                <br>
                ...
                <h4 class="text-theme mt-5">7. SERVICE USE</h4>
                <p class="mb-5">Sendplex will provide the Services in accordance with industry standards.
                <br>
                ...
                <p>You must only use the Services –</p>
                <ul class="list-unstyled list-icon mb-3">
                <li class="mb-3"><i class="flaticon-tick"></i>in accordance with the with Your Agreement with Sendplex;</li>
                <li class="mb-3"><i class="flaticon-tick"></i>for lawful purposes;</li>
                <li class="mb-3"><i class="flaticon-tick"></i>in accordance with the “U.S. Consumer Best Practices for Messaging,” promulgated by the Mobile Marketing Association (“Best Practices”);</li>
                <li class="mb-3"><i class="flaticon-tick"></i>in accordance with our Acceptable Use Policy</li>
                <li class="mb-3"><i class="flaticon-tick"></i>in accordance with all applicable local, national and international laws and regulations, including but not limited to, the Telephone Consumer Protection Act, 47 U.S.C. § 277, and regulations or guidelines interpreting it (“TCPA”); and </li>
                <li class="mb-3"><i class="flaticon-tick"></i>for the purposes for which they are designed.</li>
                </ul>
                <p>When You use our Services, You must not –</p>
                <ul class="list-unstyled list-icon mb-3">
                <li class="mb-3"><i class="flaticon-tick"></i>do anything which violates any terms of Your Agreement with Sendplex;</li>
                <li class="mb-3"><i class="flaticon-tick"></i>send junk text (SMS) messages, spam or any unsolicited messages (commercial or otherwise);</li>
                <li class="mb-3"><i class="flaticon-tick"></i>make any misrepresentation including, without limitation, those that may deceive, mislead, defraud or otherwise misrepresent any fact or circumstance to any person;</li>
                <li class="mb-3"><i class="flaticon-tick"></i>impersonate, attempt to impersonate, or otherwise misrepresent Your identity to any person for whatever purpose or create a false identity mobile phone address or header;</li>
                <li class="mb-3"><i class="flaticon-tick"></i>change the content of communications received by You and thereafter forward same to others without indicating the nature of the changes; and forge or otherwise manipulate origination details and data on any electronic data message with a view to disguising or deleting the origin of anything transmitted using our Service;</li>
                <li class="mb-3"><i class="flaticon-tick"></i>transmit anything (including, without limitation, words and images) which, in Sendplex’s opinion, may be defamatory, discriminatory, obscene, lewd, offensive, threatening, abusive, harassing, harmful, hateful or which may contain child or violent pornography, religious or racial slurs or may threaten or encourage bodily harm or the like or which may violate any person’s rights regardless of whether such content is accessed, transmitted, propagated, distributed, created or stored in a public or private context;</li>
                <li class="mb-3"><i class="flaticon-tick"></i>commit fraud or solicit or induce any person to participate in any commercial or non-commercial activities which are in the nature of a financial scam, “pyramid schemes" or “chain letters";</li>
                <li class="mb-3"><i class="flaticon-tick"></i>violate or infringe any intellectual property rights;</li>
                </ul>
                <p>In addition, You must not do anything which does or may – </p>
                <ul class="list-unstyled list-icon mb-3">
                <li class="mb-3"><i class="flaticon-tick"></i>damage, impair, overburden or disable any system of any person (including us) using our Services;</li>
                <li class="mb-3"><i class="flaticon-tick"></i>interfere with another person’s use and enjoyment of the Service or of similar services;</li>
                <li class="mb-3"><i class="flaticon-tick"></i>interfere with or disrupt networks connected to the Service or violate the regulations, policies or procedures of such networks; or compromise or tamper with the security of our or any other person’s software, hardware, systems, networks or services;</li>
                <li class="mb-3"><i class="flaticon-tick"></i>transmit any computer code which is designed to harm, or has the effect of harming, the operation of any software, hardware or network, including, without limitation, viruses, Trojan horses, worms, time bombs and cancelbots;</li>
                <li class="mb-3"><i class="flaticon-tick"></i>harvest or collect information about others, including email addresses, without their consent, for any reason;</li>
                <li class="mb-3"><i class="flaticon-tick"></i>violate the privacy of any person;</li>
                <li class="mb-3"><i class="flaticon-tick"></i>reproduce, duplicate, copy, sell or re-sell any of our Services or any part thereof (including, without limitation, websites and web pages, or any services that constitute the provision of telecommunications services in terms of applicable legislation); or the information or data contained in our services;</li>
                <li class="mb-3"><i class="flaticon-tick"></i>repeatedly or in a rapid manner transmit content in such a manner as to have the effect of harassing a recipient;</li>
                <li class="mb-3"><i class="flaticon-tick"></i>transmit content that You do not own or do not have the right to publish or distribute;</li>
                <li class="mb-3"><i class="flaticon-tick"></i>access any of our Services or any similar service of any third party or any network without authorization or through hacking, password mining or any other means;</li>
                <li class="mb-3"><i class="flaticon-tick"></i>perform any illegal activities including (without limitation) promoting or facilitating access to, use of or sale of dangerous substances or devices;</li>
                <p>We encourage the use and publicity of anti-spam policies.</p>
                </ul>
                <p><b>Passwords</b></p>
                <p>We provide You with a login and password.  Any security measures over and above these are Your responsibility.</p>
                <p>Although we provide API connection specifications and will attempt to keep the specifications accurate and up to date, these specifications may be incomplete and may change from time to time without notice to You. You must test the specifications thoroughly on a regular basis, as we are not liable for specifications that may be incorrect or incomplete.</p>
                <ul class="list-unstyled list-icon mb-3">
                <li class="mb-3"><i class="flaticon-tick"></i>must keep Your password, account name and account information confidential and must not disclose these to third parties;</li>
                <li class="mb-3"><i class="flaticon-tick"></i>must not circumvent, or attempt to circumvent, our user authentication systems;</li>
                <li class="mb-3"><i class="flaticon-tick"></i>are entirely responsible for all payments and any activities that occur under Your account;</li>
                <li class="mb-3"><i class="flaticon-tick"></i>are liable for any damage, loss or costs that we or any third party sustain howsoever arising as a result of any of Your actions, or any actions of a third party using Your password, account name or account information; and indemnify us against any claim howsoever arising from any use of Your password, account name or account information by a third party or as a result of Your breach of this clause.</li>
                <p>You must tell us immediately if there is any unauthorized use of Your account or any other breach of security.</p>
                </ul>
                <p><b>Adding Contacts</b></p>
                <p>Sendplex gives You the ability to add single contacts and/or the ability to upload multiple contacts. You agree by uploading or adding contacts You are solely responsible for the collection of these numbers.  You further represent and warrant that You have gotten prior written consent (“Opt-In”) from these individuals to send them text or email messages, and further You agree to provide documentation of Opt-In if requested by Sendplex.</p>
                <p><b>Mobile Contests & Sweepstakes (Text-to-Win)</b></p>
                <p>If Licensee uses Services to conduct contests or sweepstakes (such as “text-to-win”) Licensee agrees that it is solely responsible for ensuring that the sweepstakes or contest applies with all applicable laws.  Further, Licensee is solely responsible for compiling and administering the sweepstakes or contest rules.  Licensee acknowledges that messages are distributed via third-party mobile network providers and, therefore, Sendplex cannot control certain factors relating to message delivery. Licensee acknowledges that, depending on the recipient’s mobile provider service, it may not be possible to transmit the message to the recipient successfully. Sendplex does not claim or guarantee availability or performance of this Service, including liability for transmission delays or message failures.</p>
                <p><b>Receiving Messages and/or initiating a message response</b></p>
                <p>Standard Text Messaging and Data rates apply for all messages sent or received.
                <br>
                ...
                <br>
                Bell Mobility, Fido (part of Rogers Wireless), Lynx Mobility, Mobilicity, MTS Mobility, Rogers Wireless, SaskTel Mobility, Telus Mobility, Vidéotron, Virgin Mobile Canada, Wind Mobile.
                </p>
                <p><b>Opt-In</b></p>
                <p>In order to receive any messages from a Sendplex managed shortcode, an individual (“User”) must initiate an opt-in expressing affirmative consent to receive messages.  
                <br><br>
                ...
                <p><b>End-User Charges</b></p>
                <p>The Sendplex Service is delivered without charge from Sendplex to the User, however Standard Message and Data Rates may apply.  Standard text message charges may appear on Licensee or User’s wireless bill or may be deducted from a prepaid balance. Licensee or User is fully liable for any mobile phone charges incurred (usage, subscription, etc.) as a result of using any of Sendplex’s Services. Licensee and User should consult their mobile service carrier’s pricing plan to determine the charges for sending and receiving text messages.</p>
                <p><b>Message Subscriptions & Alerts</b></p>
                <p>By Opting-In to a program, Licensee or User grants consent to Licensee and Sendplex to receive text messages from Licensee through Sendplex’s Services.  </p>
                <p><b>Message Subscriptions & Alerts</b></p>
                <p>By Opting-In to a program, Licensee or User grants consent to Licensee and Sendplex to receive text messages from Licensee through Sendplex’s Services. </p>
                <p><b>Opt-Out/Unsubscribe</b></p>
                <p>Users can opt-out or unsubscribe from this Service at any time.  To opt-out, the User can text STOP to the Sendplex managed shortcode from User’s mobile phone.  (for example. STOP to 24587)  In addition to STOP, UNSUBSCRIBE, EXIT, QUIT, CANCEL can be texted to the shortcode to opt-out.  Licensee may also opt-out Users through the  Sendplex Mobile Marketing and Messaging Platform.</p>
                <p><b>Message Delivery</b></p>
                <p>Messages are deemed to have been delivered when we have delivered or sent the messages to the immediate destination that our software is programmed for, including SMTP servers, mobile telephone networks, or any other intermediary server or API that Sendplex deems  to be the point of dispatch of the message.<br><br>
                ...
                <p><b>Messages and Other Limitations</b></p>
                <p>Sendplex is not responsible for the deletion or failure to store information by Licensee.
                <br><br>
                ...
                <h4 class="text-theme mt-5">8. SERVICE AVAILABILITY</h4>
                <p class="mb-5">
                ...
                <ul class="list-unstyled list-icon mb-3">
                <li class="mb-3"><i class="flaticon-tick"></i>1. equipment malfunctions;</li>
                <li class="mb-3"><i class="flaticon-tick"></i>2. periodic maintenance procedures or repairs that Sendplex may undertake from time to time; or</li>
                <li class="mb-3"><i class="flaticon-tick"></i>3. causes beyond the control of  Sendplex or that are not reasonably foreseeable by Sendplex including, without limitation, interruption or failure of telecommunication or digital transmission links, hostile network attacks network congestion or other failures.</li>
                </ul>
                <p>Licensee agrees Sendplex has no control of availability of the Services on a continuous or uninterrupted basis. Licensee further agrees that as a normal course of its business, it may be necessary for Sendplex to migrate its servers. As a result, even though Licensee may have a dedicated IP, Licensee may be assigned a different IP number.  Sendplex does not warrant that Licensee will be able to consistently maintain its given IP numbers.</p>
                <h4 class="text-theme mt-5">9. SERVICE AVAILABILITY LIMITED CREDIT</h4>
                <p class="mb-5">Sendplex strives to maintain a service uptime for the Services of 99.9% (“Service Uptime") of available time. If Sendplex fails to maintain this level of service availability, You may request a credit of any messages that may have not sent during the downtime period. All credits will be in the form of message credits added back to Your account and not a monetary value or cash.   </p>
                <p>The credit does not apply to service interruptions caused by:</p>
                <ul class="list-unstyled list-icon mb-3">
                <li class="mb-3"><i class="flaticon-tick"></i>
                    1. periodic scheduled maintenance or repairs Sendplex may undertake from time to time;
                </li>
                <li class="mb-3"><i class="flaticon-tick"></i>
                ...
                <li class="mb-3"><i class="flaticon-tick"></i>
                    4. causes beyond the control of Sendplex or that are not reasonably foreseeable by Sendplex;
                </li>
                <li class="mb-3"><i class="flaticon-tick"></i>
                    5. outages related to the reliability of certain programming environments; and
                </li>
                <li class="mb-3"><i class="flaticon-tick"></i>
                    6. message delivery outside the control of Sendplex.
                </li>
                </ul>
                <p>Total Service Uptime shall be solely determined by Sendplex and shall be calculated on a monthly basis.</p>
                <h4 class="text-theme mt-5">10. PRIVACY</h4>
                <p class="mb-5">
